...
I will attempt to look at issues as soon as possible, but remember that the project is maintained in my free time. If you wish to speed up the process, fork the repository, create a new bugfix branch and, once you have fixed the bug, submit a pull request for review.
...
#### main
The _main_ branch is the **final** repository, from which **releases** are created.

You can only push commits via a _pull requests_. Everytime a push is made on this branch, the associated action activates to perform the following operations:
